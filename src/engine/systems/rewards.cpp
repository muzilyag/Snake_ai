                   ...
                   const RewardConfig& config, float* rewards) 
    {
        for (int e = 0; e < num_envs; ++e) {
            for (int s = 0; s < snakes_per_env; ++s) {
                ...
                if (event == 1) base_reward += config.params[role][0];
                else if (event == 2) {
                ...
                else if (event == 3) base_reward += config.params[role][2];
                else if (event == 4) base_reward += config.params[role][1] + config.params[role][3];
                else if (event == 5) base_reward += config.params[role][1];
                else base_reward += config.params[role][4];
